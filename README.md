...
ShareFile v2 — это премиум версия веб-приложение для обмена файлами. Оно позволяет зарегистрированным пользователям загружать файлы, генерировать защищённые ссылки для скачивания с возможностью установки PIN-кода и лимита скачиваний.
