...
ShareFile v1 — бесплатная версия веб-приложение для обмена файлами. Оно позволяет зарегистрированным пользователям загружать файлы, генерировать защищённые ссылки для скачивания с возможностью установки PIN-кода и лимита скачиваний.
...
- Загрузка файлов любых типов (до 5 мб)
- Лимит скачиваний 5
